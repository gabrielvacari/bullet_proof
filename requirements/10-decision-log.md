...
**Overrides:** Original draft item 4, *"5 Shots to die"*.
...
**Overrides:** The ambiguity in original draft item 8, *"if a player is inside a room the
other one cannot see where he is"*.
